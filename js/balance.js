...
var TOKEN_ADDRESS = '0xc98a910ede52e7d5308525845f19e17470dbccf7' //wilc ropsten contract address
	...
	if ($('#inputbalance').val() != "") {
	 try {
		ethers.utils.getAddress(address); //ethers.js kütüphanesinden adres kontrolü yapar
			var callPromise = tokenContract.functions.balanceOf(address); //ethers.js kütüphanesinden bakiye kontrolü yapar
				console.log(tokenContract);
					...
					callPromise.then(function(result) {
						...
						$(".modalcontent").html("Your Wrapped ILCOIN balance: " + finalbalance + " WILC");
						$("#inputbalance").val("");
			...
			$(".modalcontent").html("Your Wrapped ILCOIN address is invalid, please type correct address. This validation is made from ethers.js library.");
			$("#inputbalance").val("");
		  return;
        }	
	} else {
		...
		$(".modalcontent").html("Please type your Wrapped ILCOIN address then click the button");
		$("#inputbalance").val("");
	}
}
